            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="medicine.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite food</a></li>
...
?>									
    ...
    <div class="title-row">
    <?php echo $item["title"]; ?><a href="medicine.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-md-8">
						...
						<?php  
									$stmt = $db->prepare("select * from medicine where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='medicine.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="store-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/medicine/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="item-img pull-left">
                                    <a class="store-logo pull-left" href="#"><img src="http://placehold.it/70x70" alt="Food logo"></a>
                                </div>
              
                                <div class="rest-descr">
                                    <h6><a href="#">All Medicine(28 - 30 cm.)</a></h6> </div>
